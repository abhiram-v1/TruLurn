...
export const mockBranches: Branch[] = [
  {
    ...
    description: 'Prediction from labeled examples: regression, classification, loss, and generalization.',
    state: 'in_progress',
    active_topic_id: 'linear-regression',
    topic_count: 7,
    mastered_count: 1,
  },
  {
    ...
    description: 'Finding structure without labels: clustering, dimensionality reduction, and representation.',
    state: 'not_started',
    active_topic_id: 'clustering-intro',
    topic_count: 5,
    mastered_count: 0,
  },
  {
    ...
    description: 'Learning useful representations from generated training signals.',
    state: 'not_started',
    active_topic_id: 'pretext-tasks',
    topic_count: 4,
    mastered_count: 0,
  },
  {
    ...
    description: 'Agents, rewards, policies, exploration, and long-horizon decision making.',
    state: 'not_started',
    active_topic_id: 'rl-intro',
    topic_count: 6,
    mastered_count: 0,
  },
]
...
export const mockTopics: Topic[] = [
  ...
  },
  {
    ...
    state: 'locked',
    understanding_level: null,
    prerequisites: ['classification-intro'],
    created_at: mockCourse.created_at,
    branch_id: 'supervised',
    section: 'Classification',
  },
...
export function getBranch(branchId: string): Branch {
  return mockBranches.find((branch) => branch.id === branchId) ?? mockBranches[0]
}

export function getBranchTopics(branchId: string): Topic[] {
  return mockTopics.filter((topic) => topic.branch_id === branchId)
}
